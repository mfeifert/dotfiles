...
export DATA_DIR="$HOME/nfs/docs/data"
export EDITOR="nvim"
export GOPATH="$HOME/vc/go"
export LEDGER_FILE="$HOME/nfs/docs/finance/current_year.ledger"
export MANPAGER="sh -c 'col --spaces --no-backspaces | bat --plain --language man'"
export MANROFFOPT="-c"
export NOTES_DIR="$HOME/nfs/docs/notes"
export PATH="$HOME/vc/scripts:$PATH"
export PATH="$HOME/vc/scripts-private:$PATH"
export PATH="$HOME/.local/bin:$PATH"
export PATH="$GOPATH/bin:$PATH"
export SHOWS_MEDIA_DIR="$HOME/nfs/video/tv shows"
...
alias hla="hledger -f ~/nfs/docs/finance/master.ledger"  # hledger all
