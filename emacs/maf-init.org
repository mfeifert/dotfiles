...
#+begin_src emacs-lisp :tangle "~/.config/emacs/maf-init.el"
  ...
  (keymap-global-set "<f5>" 'maf-task-list-and-agenda)
...
#+begin_src emacs-lisp :tangle "~/.config/emacs/maf-init.el"
  (use-package evil
    ...
    (add-hook 'org-mode-hook (lambda ()
                               (keymap-local-unset "M-h") ; org-mark-element
                               (keymap-local-unset "M-t") ; downcase-word
                               ))
...
#+begin_src emacs-lisp :tangle "~/.config/emacs/maf-init.el"
  ...
  (defun maf-task-list-and-agenda ()
    ...
    (find-file "~/docs/org/tasks.org")
    (display-line-numbers-mode -1)
    (find-file "~/docs/org/task-list.org")
    (display-line-numbers-mode -1)
    (org-agenda-list)
    (balance-windows)
    (other-window 1))
